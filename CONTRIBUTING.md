...
**Repo:** https://github.com/vkoul/ab-test-content  
**Live site:** https://vkoul.github.io/ab-test-content/  
...
```yaml
run: BASE_URL=/ab-test-content jupyter-book build --html
```
If you rename the repo, update this value to match.

### Build fails in GitHub Actions
1. Go to https://github.com/vkoul/ab-test-content/actions
...
6. **To update notebook data paths for Colab** — users opening in Colab won't have `../data/` available. Consider adding a cell at the top of notebooks that downloads data from the raw GitHub URL:
   ```python
   # For Colab users:
   # !wget https://raw.githubusercontent.com/vkoul/ab-test-content/main/data/dataset_autotitle.csv
   ```

7. **Custom domain** — if you ever want `abtesting.yourdomain.com` instead of `vkoul.github.io/ab-test-content`, add a `CNAME` file to the repo root with your domain, and configure DNS to point to GitHub Pages.
